      ...
      <div className="container-px">
        <div className="flex items-center justify-between h-16 lg:h-16">
          <div className="flex items-center gap-3 lg:gap-4">
            <div className="w-32 h-8 bg-neutral-200 rounded-md" aria-label="Logo">{/* [Placeholder: Logo] */}</div>
          </div>
          ...
          <a href="#" className="hover:text-neutral-900">Search</a>
            <Link to="/locations" className="hover:text-neutral-900">Locations</Link>
      ...
      >
        <div className="container-px h-full flex flex-col py-6">
          ...
          <nav className="mt-8 flex flex-col gap-5 text-lg text-neutral-800">
            <Link to="/locations" onClick={() => setOpen(false)} className="hover:text-neutral-900">Locations</Link>
            <a href="#" className="hover:text-neutral-900">Sizing</a>

...
import LocationPin from "../../assets/images/LocationPin.jpg"
...
const features = [
  { 
    id: 1, 
    text: "No hidden or additional fees", 
    iconUrl: Dollar // IMPORTANT: Replace with actual path
  },
  { 
    id: 2, 
    text: "Storage near home and work", 
    iconUrl: LocationPin // IMPORTANT: Replace with actual path
  },
  { 
    id: 3, 
    text: "Month to Month Leases", 
    iconUrl: Calendar // IMPORTANT: Replace with actual path
  },
  { 
    id: 4, 
    text: "Complimentary padlock", 
    iconUrl: Lock // IMPORTANT: Replace with actual path
  },
];
